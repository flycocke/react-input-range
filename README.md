...
1. Install `react-input-range-revision` using npm (or [yarn]). `npm install react-input-range-revision`
2. Import `react-input-range-revision` to use `InputRange` component.
